...
const TopNav = () => {
  ...
  return <> <nav className={` shadow-sm flex items-center justify-center  dark:bg-neutral-950 dark:text-white   z-100 bg-white fixed lg:w-full w-max300 ${open ? ' ' : ' max-lg:w-full '}`} >
...
export const Route = createFileRoute('/__app')({
  component: () => (
    <>
      <TopNav />
      <main className=' mx-auto w-full pt-12 not-dark:text-black dark:text-white'>
        <Outlet />
      </main>
      <Footer/>
    </>
