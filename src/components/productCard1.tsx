...
export const ProduCard1 = ({ price, className, to, url = "/src/assets/images/lap.png", title, describtion }: { url?: string, className?: string, price: string, title: string, describtion: string, id: string | number, to: string }) => {
