...
export default () => {
  ...
  return <>
    ...
    <button disabled={loading} type="button" onClick={login} className="flex items-center justify-center  theme2cont not-dark:text-gray-600 ha rounded-lg shadow-md hover:bg-gray-100">
